...
| 平台 | 安装包 |
|------|--------|
| Windows x64 | [AI-Vault_0.2.4_x64-setup.exe](https://github.com/ErgeAIA/updates-dist/releases/download/aivault-v0.2.4/AI-Vault_0.2.4_x64-setup.exe) |
| macOS Apple Silicon | [AI-Vault_0.2.4_aarch64.app.tar.gz](https://github.com/ErgeAIA/updates-dist/releases/download/aivault-v0.2.4/AI-Vault_0.2.4_aarch64.app.tar.gz) |
| macOS Intel | [AI-Vault_0.2.4_x86_64.app.tar.gz](https://github.com/ErgeAIA/updates-dist/releases/download/aivault-v0.2.4/AI-Vault_0.2.4_x86_64.app.tar.gz) |
